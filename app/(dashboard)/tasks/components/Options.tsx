  ...
  return (
    <>
      <div className='hidden lg:flex gap-x-5'>
        <Button onClick={() => setTaskModalStatus(!(taskModalStatus))} variant='primary'><PlusIcon className='w-4 stroke-width-3' /></Button>
      ...
      <Modal dependency={taskModalStatus} close={() => setTaskModalStatus(!(taskModalStatus))}>
        <AddTask taskModalStatus={taskModalStatus} setTaskModalStatus={setTaskModalStatus} />
      </Modal>
    </>
  )
}
