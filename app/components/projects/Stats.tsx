...
export default function Stats ({ stats }: { stats: ProjectStatsInterface }): JSX.Element {
  ...
  return (
    <div className='relative text-white bg-dark-gray pt-7 pb-[34px] pr-7 pl-7'>
      ...
      {stats.bestProjectOfPastMonth !== '' && <FireIcon className='h-10 stroke-2 text-light-gray' />}
      {stats.bestProjectOfPastMonth === '' && <ChartBarIcon className='h-10 stroke-2 text-light-gray' />}
