  ...
  return (
    <div className='flex flex-col items-center h-full mt-28 gap-y-5'>
      <Image
        ...
        alt='Not found image'
      />
      <span className='text-xl text-center font-secondaryFont text-dark-gray'>There are no projects to display, but there is a solution... <br className='hidden lg:block' /> You can add the first one right now.</span>
