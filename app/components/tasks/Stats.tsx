    ...
    >
      ...
      <SwiperSlide className='text-white bg-dark-gray pt-7 pb-[33px] pr-7 pl-7'>
        ...
        <div className='flex items-center text-4xl font-bold gap-x-1 mt-7 font-primaryFont'>
          {TASK_STATS[0].value}
          {TASK_STATS[0].avg === 'better' && <ArrowUpIcon className='w-4 stroke-custom-green stroke-4' />}
          {TASK_STATS[0].avg === 'worst' && <ArrowDownIcon className='w-4 stroke-custom-red stroke-4' />}
        </div>
