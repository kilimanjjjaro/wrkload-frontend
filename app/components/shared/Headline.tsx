...
export default function Headline ({ variant, children }: Props): JSX.Element {
  return (
    <h2 className={clsx(
      variant === '2xl' && 'mb-10 text-[51px] leading-none font-bold md:mb-14 2xl:mb-16 font-primaryFont md:text-6xl xl:text-7xl 2xl:text-8xl',
      ...
      variant === 'md' && 'text-xl mb-7 md:mb-10 font-primaryFont md:text-3xl 2xl:text-4xl'
    )}
    >{children}
    </h2>
  )
