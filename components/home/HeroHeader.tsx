    ...
    <Swiper>
      <SwiperSlide>
        <section className='grid items-center gap-32 md:gap-10 md:h-screen md:grid-cols-2'>
          ...
          <Masonry
            className='grid items-start grid-cols-2'
          ...
          >
            ...
            >
              ...
              >
                <motion.div
                  className='absolute left-0 right-0 flex justify-center items-center w-[82px] transition-opacity duration-400 ease-in-out h-8 mx-auto text-sm text-black bg-blue dark:bg-white rounded-full -top-[1.05rem] font-secondaryFont group-hover:opacity-0'
            ...
            <article className='p-6 -mb-3 scale-[0.75] bg-light-blue dark:bg-blue md:p-7 rounded-3xl transition duration-400 ease-in-out'>
            ...
            <article className='p-6 mt-5 scale-[0.75] bg-light-blue dark:bg-blue md:p-7 rounded-3xl transition duration-400 ease-in-out'>
              <div className='w-4/6 mb-4 xl:mb-5 h-9 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-full animate-skeleton' />
              <div className='w-full h-28 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-3xl animate-skeleton' />
              <div className='flex flex-wrap w-full gap-3 mt-4'>
                <div className='w-2/6 h-8 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-full animate-skeleton' />
            ...
            <article className='p-6 scale-[0.75] bg-light-blue dark:bg-blue md:p-7 rounded-3xl transition duration-400 ease-in-out'>
              <div className='w-4/6 mb-4 xl:mb-5 h-9 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-full animate-skeleton' />
              <div className='w-full h-28 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-3xl animate-skeleton' />
              <div className='flex flex-wrap w-full gap-3 mt-4'>
                <div className='w-2/6 h-8 bg-gradient-to-r from-white dark:from-light-blue via-blue dark:via-white/30 to-white dark:to-light-blue bg-[length:200%_100%] rounded-full animate-skeleton' />
      ...
      <SwiperSlide>
        <section className='grid items-center gap-32 md:gap-10 md:h-screen md:grid-cols-2'>
          ...
          >
            ...
            <article
              data-atropos-offset='6'
              className='transition ease-in-out border-2 pt-7 pr-7 pb-6 pl-7 border-blue text-blue dark:text-blue dark:border-blue rounded-3xl duration-400 scale-[0.75]'
            >
            ...
            <article
              data-atropos-offset='6'
              className='transition ease-in-out mt-8 border-2 pt-7 pr-7 pb-6 pl-7 border-blue text-blue dark:text-blue dark:border-blue rounded-3xl duration-400 scale-[0.85]'
            >
