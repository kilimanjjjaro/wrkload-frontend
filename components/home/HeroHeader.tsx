...
export default function HeroHeader (): JSX.Element {
  ...
  return (
    <div className='grid items-center h-screen grid-cols-2 gap-10'>
      <div className='flex flex-col items-start text-pink'>
        <Headline variant='2xl'>Work, load your <br />time and go <br />have fun!</Headline>
        <div className='mb-8 text-white md:w-1/2'>
          <Paragraph variant='normal'><b className='font-extrabold'>Easy-peasy!</b><br /> With wrkload you can track what you&apos;ve worked on in a simple and organized way.</Paragraph>
        </div>
        <Button variant='primary' onClick={() => router.push('/registry')}>Start now for free <ArrowRightIcon className='w-4 stroke-3' /></Button>
      </div>
      <div className='w-full bg-black h-2/3' />
    </div>
  )
}
