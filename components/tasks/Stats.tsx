    ...
    <>
      ...
      {stats.totalTasksPastMonth < 1 && (
        <div className='relative text-black bg-light-pink pt-7 pb-[34px] pr-7 pl-7'>
          ...
          <span className='block text-2xl font-secondaryFont mt-7'><Balancer>We can&apos;t wait to show you stats but it looks like it&apos;s your first month or you didn&apos;t upload tasks last month.</Balancer></span>
        </div>
      )}
    </>
  )
