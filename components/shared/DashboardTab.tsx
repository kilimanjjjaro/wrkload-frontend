...
export default function DashboardTab ({ showDashboardBox, setShowDashboardBox }: Props): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <ul className='flex flex-col items-center justify-center w-full h-full gap-6 text-3xl text-black md:gap-4 md:text-xl md:flex-row md:w-auto rounded-t-3xl md:rounded-3xl font-secondaryFont'>
        {pages.map((page) => (
